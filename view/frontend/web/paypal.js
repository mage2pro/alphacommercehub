...
return parent.extend(df.o.merge(mixin, {
	defaults: {df: {formTemplate: 'Dfe_AlphaCommerceHub/paypal', alphacommercehub: {suffix: 'paypal'}}},
	/**
	 * 2017-07-26
	 ...
	 * @returns {Object}
	 */
	dfData: function() {return _.assign(this._super(), {option: this.df.alphacommercehub.suffix});}
}));});